...
with open("D:/DevOps/Python/APiPy/kaspersky/files/c412341de164496c869b1ee1beb51bc099bb1940f6a44fcb8c44f2b32cec6e77.pfx", "rb") as f:
    private_key, certificate, additional_certificates = pkcs12.load_key_and_certificates(f.read(), b"89)iopJKL")

    key = open("D:/DevOps/Python/APiPy/kaspersky/files/key.pem", 'wb')
    cert = open("D:/DevOps/Python/APiPy/kaspersky/files/cert.pem", 'wb')
    key.write(
